...
window.GameData.Quests = [
    // 1. Monster Hunts
    {
        ...
        type: "HUNT",
        rank: "F",
        tags: ["beast", "disease_risk", "indoors", "swarm"],
    ...
    },
    {
        ...
        type: "HUNT",
        rank: "D",
        tags: ["beast", "ambush", "forest", "night"],
    ...
    },
    {
        ...
        type: "HUNT",
        rank: "C",
        tags: ["construct", "golems", "hard_shell", "magic_reflect"],
    ...
    },
    {
        ...
        type: "HUNT",
        rank: "B",
        tags: ["humanoid", "magic", "swamp", "poison", "charm"],
    ...
    },
    {
        ...
        type: "HUNT",
        rank: "S",
        tags: ["dragon", "fire", "volcano", "flying"],
    ...
    // 2. Escort Missions
    {
        ...
        type: "ESCORT",
        rank: "E",
        tags: ["escort", "slow", "patience_required"],
        client: "Fat Merchant",
    ...
    },
    {
        ...
        type: "ESCORT",
        rank: "B",
        tags: ["escort", "royal", "guards_enemy", "stealth_preferred"],
        client: "Hooded Girl",
    ...
    // 3. Retrieval
    {
        ...
        type: "RETRIEVAL",
        rank: "D",
        tags: ["retrieval", "climb", "falling_risk"],
        item: "Sun-Bloom",
        location: "Cliffside",
    ...
    },
    {
        ...
        type: "RETRIEVAL",
        rank: "C",
        tags: ["retrieval", "stealth_required", "traps"],
        item: "Gold Locket",
    ...
    // 4. Mysteries
    {
        ...
        type: "MYSTERY",
        rank: "D",
        tags: ["mystery", "undead_fake", "bandits"],
